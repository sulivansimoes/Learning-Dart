...
num _calculoDeImc(altura, peso) {
  if (!peso.toString().contains(RegExp(r'[0-9]'))) {
    print('Não foi digitado um número no peso');
    return _naoCalculado;
  }

  if (!altura.toString().contains(RegExp(r'[0-9]'))) {
